...
const server = new Server(
  { name: "programming-expert", version: "1.0.0" },
  { capabilities: { tools: {} } }
);

const LANGUAGE_RESOURCES: Record<string, { official: string, grammar: string, best_practices: string, common_patterns: string }> = {
  "java": {
